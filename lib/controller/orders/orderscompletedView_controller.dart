...
class OrderscompletedViewController extends GetxController {
  OrderscompletedViewData orderscompletedViewData = OrderscompletedViewData(Get.find());
  ...
  getOrders() async {
    ...
    update();
    var response = await orderscompletedViewData.getData();
